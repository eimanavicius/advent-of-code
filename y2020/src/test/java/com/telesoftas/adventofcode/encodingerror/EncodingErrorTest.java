...
class EncodingErrorTest {
    ...
    void part2_1() {
        ...
        List<Long> range = EncodingError.findEncryptionWeaknessRange(SAMPLE, erroneous);

        assertEquals(List.of(15L, 25L, 47L, 40L), range);
    }

    @Test
    void part2_2() {
        final List<Long> weaknessRange = List.of(15L, 25L, 47L, 40L);
